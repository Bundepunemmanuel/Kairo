...
async function scorePosts(posts, analysis) {
  // Take first 40 posts — safely within Groq free tier's 8K TPM limit for
  // openai/gpt-oss-120b (~40 posts ≈ 4,000 input tokens), while covering
  // roughly 2x more ground than before. Posts arrive already round-robin'd
  // across subreddits from cron-scan, so this sample is spread fairly
  // rather than dominated by whichever subreddit was fetched first.
