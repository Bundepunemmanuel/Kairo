...
// Scoring: Cerebras llama3.1-70b (primary, 1M tokens/day) → Groq openai/gpt-oss-120b (fallback) → Nemotron 3 Ultra via OpenRouter free tier (final fallback, no retry)
...
Posts: ${JSON.stringify(input)}`,
  ...
  if (!raw) {
    ...
    raw = await nemotron(messages, 1500, 0.1)
  }
