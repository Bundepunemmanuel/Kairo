    ...
    <>
      ...
      <div className="dash-page">
        <nav className="dash-nav">
          <Link href="/dashboard" className="dash-nav-logo" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 8 }}>
            <KairoLogo size={22} />
            <span style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.1rem', fontWeight: 700, color: '#1a1208' }}>Kairo</span>
          </Link>
          <div className="dash-nav-right">
            <Link href="/dashboard" className="dash-nav-settings">← Dashboard</Link>
          </div>
        </nav>
        ...
        <div className="settings-container">
          ...
          <section className="settings-section">
            ...
            {plan !== 'unlimited' && (
              <a href={GOOGLE_FORM} target="_blank" rel="noopener noreferrer" className="settings-btn settings-btn-upgrade">
                Upgrade plan →
              </a>
            )}
          </section>
