...
The product solves: ${analysis.specificProblems?.join(' | ') || ''}

Do NOT ask "does this person need this specific product". Ask "is this person experiencing one of the problems above?"

9-10: Person is explicitly struggling with one of the specific problems above AND actively seeking a solution or tool
7-8: Person is clearly experiencing one of the specific problems above, even if not actively shopping
5-6: Pain loosely relates to the problem space
Below 5: REJECT
