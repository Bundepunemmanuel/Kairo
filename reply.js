...
function humanizeText(text) {
  ...
  // and double-hyphen-as-dash (--) all get used by AI models in the same
  // unnatural "formal writing" way. Same contextual handling for all:
...
// rules, confirmed via real removals and documented community policies.
// No amount of humanizing the writing avoids removal here, since the
// rule targets the *structure* (problem → pitch), not the wording. For
// these, drop the product mention entirely and just write a genuinely
// helpful, plug-free comment.
// Add more here as you confirm other subreddits enforce the same rule.
const NO_PITCH_SUBREDDITS = [
  'saas', 'startups', 'smallbusiness', 'marketing',
  'freelance', 'webdev', 'copywriting', 'programming',
]
